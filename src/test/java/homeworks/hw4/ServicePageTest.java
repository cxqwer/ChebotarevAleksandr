...
public class ServicePageTest extends SelenideBase {
    ...
    private static final SupportData[] selectedCheckboxes = new SupportData[]{
    ...
    public void tests() {
        ...
        servicePage.openHeaderDifferentElements();
        ...
        supportPage.selectBoxes(selectedCheckboxes);

        // 12 Assert that for each checkbox there is an individual log row and value is corresponded to the status of checkbox. 
        supportPage.chekChekboxesTrueInLog(selectedCheckboxes);
        ...
        supportPage.chekChekboxesFalseInLog(selectedCheckboxes);
    }
}
